...
t.add("security.login.username", "Identifiant", "FOSUserBundle", "fr");
...
t.add("profile.show.username", "Identifiant", "FOSUserBundle", "fr");
t.add("profile.show.email", "Adresse e-mail", "FOSUserBundle", "fr");
t.add("profile.edit.submit", "Mettre \u00e0 jour", "FOSUserBundle", "fr");
t.add("profile.flash.updated", "L'utilisateur a \u00e9t\u00e9 mis \u00e0 jour avec succ\u00e8s !", "FOSUserBundle", "fr");
...
t.add("registration.submit", "Enregistrer", "FOSUserBundle", "fr");
...
t.add("form.password_confirmation", "V\u00e9rification", "FOSUserBundle", "fr");
t.add("form.new_password", "Nouveau mot de passe", "FOSUserBundle", "fr");
t.add("form.new_password_confirmation", "V\u00e9rification", "FOSUserBundle", "fr");
t.add("change_password.forgotten_password", "Mot de passe oubli\u00e9 ?", "FOSUserBundle", "fr");
t.add("resetting.password_already_requested", "Un nouveau mot de passe a d\u00e9j\u00e0 \u00e9t\u00e9 demand\u00e9 pour cet utilisateur dans les derni\u00e8res 24 heures.", "FOSUserBundle", "fr");
})(Translator);
