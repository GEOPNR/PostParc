...
(function ($) {
    $.extend(true,$.summernote.lang, {
        'en-US': {
            pageTemplates: {
                tooltip:     Translator.trans('summernote.selectPageTemplate'),
                dialogTitle: Translator.trans('summernote.pageTemplates'),
                editBtn:     Translator.trans('summernote.insert')
            },
            blocks: {
                tooltip:     Translator.trans('summernote.blocks'),
                dialogTitle: Translator.trans('summernote.blocks'),
                editBtn:     Translator.trans('summernote.insert')
            }
        }
    });
        ...
        'pageTemplates': function (context) {
            ...
            this.initialize = function () {
                ...
                this.$dialog   = ui.dialog({
                    ...
                    body:   body,
                    footer: '<button href="javascript:void(0);" class="btn btn-primary note-pageTemplates-btn">' + lang.pageTemplates.editBtn + '</button>'
            ...
            this.showpageTemplatesDialog = function () {
                return $.Deferred(function (deferred) {
                    ...
                    ui.onDialogShown(self.$dialog, function () {
                        ...
                        $.get(options.pageTemplates.templates + 'index.php').done(function (data) {
        ...
        'blocks': function (context) {
            ...
            this.initialize = function () {
                ...
                var body = '<div id="note-blocks" style="max-height:310px;overflow:auto;"></div>' +
                  ...
                  '  <label for="note-image-attributes-link-class" class="control-label">' + Translator.trans('summernote.replaceContent') + '</label>' +
            ...
            this.showblocksDialog = function () {
                return $.Deferred(function (deferred) {
                    ...
                    ui.onDialogShown(self.$dialog, function () {
                        ...
                        var ii = 1;
                        $('#note-blocks').html('');
                        $.get(options.blocks.templates + 'index.php').done(function (data) {
                            $(data).find("a").attr("href", function (i,val) {
                                if (val.match(/\.(html)$/)) {
                                    var filename = val.replace('.html', '.png');
                                    var name = val.replace(/.html|%20|_/gi, ' ');
