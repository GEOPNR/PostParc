...
namespace PostparcBundle\Listener;
...
class DoctrineExtensionListener implements ContainerAwareInterface
{
    ...
    public function onKernelRequest(GetResponseEvent $event)
    {
        ...
        if (null !== $securityContext && null !== $securityContext->getToken() && $securityAuthorizationChecker->isGranted('IS_AUTHENTICATED_REMEMBERED')) {
